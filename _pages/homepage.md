...
<div class="col-sm-6">
<style data-emotion-css="1tgpsiod">.css-1tgpsiod{display:inline-block;border-style:solid;border-width:1px;text-align:center;text-shadow:none;-webkit-transition:color 0.2s linear,background 0.2s linear,border-color 0.2s linear, text-shadow 0.2s linear;transition:color 0.2s linear,background 0.2s linear,border-color 0.2s linear, text-shadow 0.2s linear;-webkit-text-decoration:none;text-decoration:none !important;width:100%;font-weight:bold;padding:12px;background:transparent;}.css-1tgpsiod,.css-1tgpsiod:focus,.css-1tgpsiod:active{border-color:rgb(0,0,0);color:rgb(0,0,0);}.css-1tgpsio:hover{background-color:rgb(0,0,0);color:rgba(255,255,255,1);}</style>
<p> </p>
